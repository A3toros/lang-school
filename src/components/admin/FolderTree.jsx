...
const FolderTree = ({ 
  ...
  const handleFileMenuClick = (e, file) => {
    ...
    console.log('📁 [FOLDER_TREE] File menu clicked for file:', file)
    console.log('📁 [FOLDER_TREE] File ID:', file.id)
    console.log('📁 [FOLDER_TREE] File name:', file.display_name)
    ...
    console.log('📁 [FOLDER_TREE] Selected file set to:', file)
    console.log('📁 [FOLDER_TREE] Show file menu set to:', file.id)
  }
  ...
  return (
    ...
    >
      ...
      {showFileMenu && (
        <div
          className="fixed bg-white border border-gray-200 rounded-lg shadow-lg z-50 py-1 min-w-[120px] file-context-menu"
          style={{
