            ...
            <div className="p-3 border-b border-gray-200 bg-gray-50">
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="px-3 sm:px-4 py-1 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors duration-200 text-xs sm:text-sm"
                >
                  Search
                </button>
              </div>
                ...
                return selectedFile ? (
                  ...
                  <div className="flex items-center justify-center h-full text-gray-500">
                    <div className="text-center">
                      ...
                      <div className="text-lg font-medium">File Preview Area</div>
                      <div className="text-sm">Click on a file in the folder tree to preview it here</div>
                    </div>
                  </div>
                )
              })()}
